...
--
-- Table structure for table `tbl_pagamentos`
--
...
CREATE TABLE `tbl_pagamentos` (
  ...
  CONSTRAINT `tbl_pagamentos_ibfk_1` FOREIGN KEY (`user_fk`) REFERENCES `tbl_users` (`user_id`),
  CONSTRAINT `tbl_pagamentos_ibfk_2` FOREIGN KEY (`reserva_fk`) REFERENCES `tbl_reservas` (`reserva_id`)
